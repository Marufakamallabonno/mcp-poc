...
# print(f"Database path: {DB_PATH}")  # Commented out to avoid interfering with MCP protocol
...
def init_db():  # Keep as sync for initialization
    try:
        ...
        with sqlite3.connect(DB_PATH) as c:
            ...
            # print("Database initialized successfully with write access")  # Commented out to avoid interfering with MCP protocol
    except Exception as e:
        # print(f"Database initialization error: {e}")  # Commented out to avoid interfering with MCP protocol
        raise
